...
var require = meteorInstall({"node_modules":{"meteor":{"meteormogul:vue-router-dist":{"vue-router.js":function(require,exports,module){

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                //
// packages/meteormogul_vue-router-dist/vue-router.js                                                             //
//                                                                                                                //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                  //
...
(function (global, factory) {
    ...
    render: function () {
      function render(_, ref) {
        ...
        if (propsToPass) {
          ...
          for (var key in meteorBabelHelpers.sanitizeForInObject(propsToPass)) {
  ...
  function resolveQuery(query, extraQuery, _parseQuery) {
    ...
    for (var key in meteorBabelHelpers.sanitizeForInObject(extraQuery)) {
  ...
  function queryIncludes(current, target) {
    for (var key in meteorBabelHelpers.sanitizeForInObject(target)) {
      if (!(key in current)) {
        return false;
      }
    }
  ...
  function assign(a, b) {
    for (var key in meteorBabelHelpers.sanitizeForInObject(b)) {
      a[key] = b[key];
    }
    ...
    function match(raw, currentRoute, redirectedFrom) {
      ...
      if (name) {
        ...
        if (currentRoute && _typeof(currentRoute.params) === 'object') {
          for (var key in meteorBabelHelpers.sanitizeForInObject(currentRoute.params)) {
  ...
  History.prototype.onReady = function () {
    function onReady(cb, errorCb) {
      if (this.ready) {
        cb();
      } else {
  ...
  History.prototype.onError = function () {
  ...
  History.prototype.transitionTo = function () {
  ...
  History.prototype.updateRoute = function () {
  ...
  var HashHistory = function (History$$1) {
    ...
    HashHistory.prototype.push = function () {
      function push(location, onComplete, onAbort) {
        var this$1 = this;
        var ref = this;
        var fromRoute = ref.current;
    ...
    HashHistory.prototype.replace = function () {
      function replace(location, onComplete, onAbort) {
        var this$1 = this;
        var ref = this;
        var fromRoute = ref.current;
    ...
    HashHistory.prototype.go = function () {
      function go(n) {
        window.history.go(n);
      }
    ...
    HashHistory.prototype.ensureURL = function () {
      function ensureURL(push) {
  ...
  var AbstractHistory = function (History$$1) {
    ...
    AbstractHistory.prototype.push = function () {
      function push(location, onComplete, onAbort) {
        var this$1 = this;
        this.transitionTo(location, function (route) {
    ...
    AbstractHistory.prototype.replace = function () {
      function replace(location, onComplete, onAbort) {
        var this$1 = this;
        this.transitionTo(location, function (route) {
    ...
    AbstractHistory.prototype.go = function () {
      function go(n) {
        var this$1 = this;
  ...
  VueRouter.prototype.match = function () {
    function match(raw, current, redirectedFrom) {
  ...
  VueRouter.prototype.resolve = function () {
    function resolve(to, current, append) {
...
var exports = require("/node_modules/meteor/meteormogul:vue-router-dist/vue-router.js");

/* Exports */
Package._define("meteormogul:vue-router-dist", exports, {
  VueRouter: VueRouter
});
